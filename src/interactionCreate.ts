  ...
  try {
    ...
    if (winnerId) {
      try {
        ...
        console.error("Grand announcement failed:", error);
      }
    }
  ...
  try {
    ...
    if (interaction.isButton()) {
      if (interaction.customId === "sigil_shop_open") {
        ...
        modal.addComponents(
          new ActionRowBuilder<TextInputBuilder>().addComponents(raffleIdInput),
          new ActionRowBuilder<TextInputBuilder>().addComponents(entryCountInput)
        );
